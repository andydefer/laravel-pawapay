...
+    }
+}
diff --git a/tests/MockPawapayClient.php b/tests/MockPawapayClient.php
new file mode 100644
index 0000000..601c55e
--- /dev/null
+++ b/tests/MockPawapayClient.php
@@ -0,0 +1,101 @@
+<?php
+
+declare(strict_types=1);
